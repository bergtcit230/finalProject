...
mongoose.connect('localhost:27017/deardiary');
...
app.use(express.static(path.join(__dirname, 'dist/projectFinal')));
...
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, 'dist/projectFinal/index.html'));
});
